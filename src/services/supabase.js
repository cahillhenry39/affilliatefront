export const mainUrl = "https://application.taskiit.com";
export const backUrl = "https://application.taskiit.com/api/v1";

// export const mainUrl = "http://localhost:3000";
// export const backUrl = "http://localhost:3000/api/v1";
